namespace Experiments
{
	partial class PickProblem
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBoxProblems
			// 
			this.groupBoxProblems.Controls.Add(this.listViewProblems);
			this.groupBoxProblems.Location = new System.Drawing.Point(12, 12);
			this.groupBoxProblems.Name = "groupBoxProblems";
			this.groupBoxProblems.Size = new System.Drawing.Size(260, 378);
			this.groupBoxProblems.TabIndex = 1;
			this.groupBoxProblems.TabStop = false;
			this.groupBoxProblems.Text = "Налични опити";
			// 
			// listViewProblems
			// 
			...
			this.Name = "PickProblem";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Изберете опит";
